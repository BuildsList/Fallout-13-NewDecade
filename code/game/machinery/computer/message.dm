...
/obj/machinery/computer/message_monitor
	...
	var/rebootmsg = "<span class='warning'>%$&(Ј: Critical %$$@ Error // !RestArting! <lOadiNg backUp iNput ouTput> - ?pLeaSe wAit!</span>"
	//Computer properties
	...
	var/obj/item/clothing/gloves/pda/customrecepient = null
	var/customjob		= "Admin"
...
/obj/machinery/computer/message_monitor/emag_act(mob/user)
	if(!emagged)
		if(!isnull(src.linkedServer))
			...
			MK.info += "<br><br><font color='red'>Ј%@%(*$%&(Ј&?*(%&Ј/{}</font>"
			...
			if(src.linkedServer == null || (src.linkedServer.stat & (NOPOWER|BROKEN)))
				...
				switch(href_list["select"])
					...
					if("Recepient")
						...
						var/list/obj/item/clothing/gloves/pda/sendPDAs = get_viewable_pdas()
						if(PDAs && PDAs.len > 0)
					...
					if("Send")
						...
						var/obj/item/clothing/gloves/pda/PDARec = null
