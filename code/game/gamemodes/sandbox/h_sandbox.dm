...
/datum/hSB
	...
	var/global/list/spawn_forbidden = list(
		...
		/obj/item/assembly,/obj/item/device/onetankbomb, /obj/item/radio, /obj/item/clothing/gloves/pda/ai,
		/obj/item/smallDelivery, /obj/item/missile,/obj/item/projectile,
