/mob/living/simple_animal
	...
	var/respawn_time_of_mob = 900000000
...
/mob/living/simple_animal/proc/targets_scan()
	if(world.time < scan_time)
		return

	scan_time = world.time + 20
	targets.Cut(1)

	var/vision_range_custom = 8
	if(istype(src, /mob/living/simple_animal/hostile))
		var/mob/living/simple_animal/hostile/H = src
		vision_range_custom = H.vision_range

	for(var/mob/living/carbon/human/H in hrange(src, vision_range_custom))
		targets += H
