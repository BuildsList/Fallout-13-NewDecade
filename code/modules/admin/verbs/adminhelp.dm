...
/client/verb/adminhelp(msg as text)
	...
	msg = "<span class='adminnotice'><b><font color=red>ПОМОЩЬ: </font><A HREF='?priv_msg=[ckey];ahelp_reply=1'>[key_name(src)]</A> [ADMIN_QUE(mob)] [ADMIN_PP(mob)] [ADMIN_VV(mob)] [ADMIN_SM(mob)] [ADMIN_FLW(mob)] [ADMIN_TP(mob)] (<A HREF='?_src_=holder;rejectadminhelp=[ref_client]'>НАХУЙ</A>) (<A HREF='?_src_=holder;icissue=[ref_client]'>ИЦ</A>):</b> [msg]</span>"
