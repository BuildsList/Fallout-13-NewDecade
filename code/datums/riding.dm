...
//MOVEMENT
/datum/riding/proc/handle_ride(mob/user, direction, engine)
	...
	if(engine)
		...
		to_chat(user, "<span class='notice'>You need start engine to drive \the [ridden.name].</span>")
...
///////////////ANIMALS////////////
//WARNING! Animal driving doesn't work with engine starting system. Need for rework
//general animals
/datum/riding/animal
	keytype = null
	generic_pixel_x = 0
