...
#define ADMIN_SC(user) "(<a href='?_src_=holder;adminspawncookie=\ref[user]'>ПЕЧЕНЬКА</a>)"
#define ADMIN_SMITE(user) "(<a href='?_src_=holder;adminsmite=\ref[user]'>ПИЗДЮЛИ</a>)"
